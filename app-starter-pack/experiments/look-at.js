...
function computeCameraView(locations, heading = 0) {
  ...
  // For a desired tilt of 60° (from vertical/nadir), we need:
  // tan(tilt) = horizontalDistance / verticalDistance  => verticalDistance = horizontalDistance / tan(tilt)
  ...
  return {
    look_at_lat: centerLat,
    look_at_lng: centerLng,
